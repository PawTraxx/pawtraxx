...
import { saveUser, getUser, getAllUsersFromDB, deleteUserFromDB, registerWithFirebase, sendPasswordReset, signInUser, signOutUser, removePasswordField } from './firebase';
...
getUser(form.email).then(function(freshUser) {
  ...
  "template_6eghfmo",
  {
    email: form.email,
    name: form.username.trim(),
    subject: "Welcome to PawTraks! 🐾",
    message: "Your PawTraks account has been created successfully.\n\nEmail: " + form.email + "\n\nStart tracking your dog's health today at https://pawtraks.vercel.app"
  },
  "a7L6bdE9Il7_VufQq"
...
function sendSimulatedEmail(to, subject, body) {
  // Log it locally still (for admin email log)
  ...
  emailjs.send(
    ...
    {
      email: to,
      name: subject.includes("deleted") ? "PawTraks User" : subject.includes("suspended") ? "PawTraks User" : to,
      subject: subject,
      message: body
    },
    "a7L6bdE9Il7_VufQq"
